# orijinal file : https://github.com/door7302/transcode-sros
# python transcode-sros.py <your-config-file>
#   or to save in file
# python transcode-sros.py <your-config-file> > flat-config.txt
